!(function (a) {
	...
	var b,
			...
			var b = function (b) {
				...
				U = function (a, c) {
					...
					if (0 === a.offset) {
						...
						T(a.node)
							? ((d = a.node.childNodes[a.offset - 1]), (e = A(d)))
				...
				V = function (a, c) {
					...
					if (A(a.node) === a.offset) {
						...
						T(a.node)
							...
							: ((d = a.node), (e = c ? A(a.node) : a.offset + 1));
					return { node: d, offset: e };
				},
				W = function (a, b) {
						...
						(this.normalize = function () {
							var a = function (a) {
									return (
										j.isVisiblePoint(a) ||
											(j.isLeftEdgePoint(a)
												? (a = j.nextPointUntil(a, j.isVisiblePoint))
												: j.isRightEdgePoint(a) &&
												  (a = j.prevPointUntil(a, j.isVisiblePoint))),
										a
									);
								},
					...
					(this.isOnEditable = m(j.isEditable)),
						...
						(this.insertNode = function (a, b) {
							var c,
								...
								h = f.getStartPoint();
							if (b)
								(d = j.isPara(h.node) ? h.node : h.node.parentNode),
									(e = j.isPara(h.node)
										? h.node.childNodes[h.offset]
										: j.splitTree(h.node, h));
							else {
		...
		s = function () {
			...
			for (
				var i = (this.afterCommand = function (a) {
			...
			(this.fontSize = function (a, b) {
				...
				(this.createLink = function (b, c, d) {
					...
					a(j).attr({ href: e, target: g ? "_blank" : "" }),
			...
			(this.update = function (b, c) {
				...
				if (f.length) {
					...
					h &&
						((h = g.head(h.split(","))),
						(h = h.replace(/\'/g, "")),
						f.find(".note-current-fontname").text(h),
						d(f, h));
				}
	...
	var z = function () {
			...
			var p = function (b) {
					...
					var d;
					return (
						(d = c.is(".note-editor, .note-air-editor")
							? c
					...
					codeview: function (a) {
						...
						q
							...
							: (e.hasCodeMirror &&
							  ...
							  h.height(p.height ? m.height() : "auto"),
							  i.activate(g),
							  h.focus()),
					...
					if (j.isControlSizing(b.target)) {
						...
						d
							.on("mousemove", function (a) {
								h.resizeTo(
									{ x: a.clientX - o.left, y: a.clientY - (o.top - q) },
									n,
									!a.shiftKey
								),
									l.update(e, { image: m }, r),
									k.update(f, { image: m }, r);
							})
				...
				E = function (b) {
					...
					if (c.length) {
						...
						if (
							-1 !==
							a.inArray(d, ["resize", "floatMe", "removeMedia", "imageShape"])
						) {
				...
				K = function (b, c) {
					...
					d
						.on("dragenter", function (a) {
							...
							d ||
								e.length ||
								(b.editor.addClass("dragover"),
								f.width(b.editor.width()),
			...
			(this.bindKeyMap = function (b, c) {
				...
				(this.attach = function (a, b) {
					b.shortcuts && this.bindKeyMap(a, b.keyMap[e.isMac ? "mac" : "pc"]),
						...
						b.airMode ||
							(J(a, b),
							a.toolbar.on("click", E),
							a.toolbar.on("mousedown", D),
			...
			code: function (b) {
				if (void 0 === b) {
					...
					if (d && d.editable) {
						...
						return (
							f && e.hasCodeMirror && d.codable.data("cmEditor").save(),

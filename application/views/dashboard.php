        ...
        <div class="content animated-panel">
            <div class="row">
                <div class="col-lg-12 text-center m-t-md">
                    <h2>Ticket Polman</h2>
                    <p>
                        Aplikasi pembuatan <strong>Ticket Polman</strong>
                    </p>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="panel-body h-200">
                            ...
                            <div class="m-t-xl">
                                ...
                                <small>
                                    ...
                                    <strong>typesetting industry</strong>. Lorem Ipsum has been.
                                </small>
                            </div>
                        </div>
                        <div class="panel-footer">This is standard panel footer</div>
            ...
            <?php $this->load->view('_partials/script/script-dashboard.php') ?>
</body>
